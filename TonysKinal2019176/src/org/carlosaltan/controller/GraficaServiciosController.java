...
public class GraficaServiciosController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     public void cargarDatos(){
        ...
        try {
           PreparedStatement procedimiento = Conexion.getInstance().getConexion().prepareCall("call sp_ContarTipoServicio;"); 
           ResultSet resultado = procedimiento.executeQuery(); 
            while (resultado.next()) {                
                pieChartData.add(new PieChart.Data(resultado.getString("tipoServicio"),
                                                resultado.getInt("fechaServicio"))); 
            }           
        } catch (Exception e) {
